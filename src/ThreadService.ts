...
export class ThreadService {
  ...
  public init  = async (): Promise<ThreadService> => {
    ...
    const key: KeyInfo = {key: process.env.REACT_APP_API_KEY || 'qsxsbiov44e2ej7sf6l4p6ta3a'}
    this.db = await Database.withKeyInfo(key, "threads.chat.demo-v0") // final variable can be undefined
    return this;
  } 
